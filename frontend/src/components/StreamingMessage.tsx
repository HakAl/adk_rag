...
export const StreamingMessage = ({ content, routingInfo }: StreamingMessageProps) => {
  return (
    <div className="flex justify-start gap-1 sm:gap-2 animate-fade-in">
      ...
      <div className="flex-1 space-y-2">
        ...
        >
          ...
          {/* Cursor indicator */}
          <span className="inline-block w-1.5 h-4 bg-primary ml-0.5 animate-pulse" aria-hidden="true" />
        </div>
      </div>
    </div>
  );
